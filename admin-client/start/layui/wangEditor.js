...
_e(function (E, $) {
    ...
    E.config.emotions = {
        'default': {
            ...
            size: 18,
            imgs: [
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/1.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/2.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/3.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/4.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/5.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/6.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/7.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/8.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/9.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/10.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/11.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/12.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/13.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/14.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/15.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/16.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/17.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/18.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/19.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/20.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/21.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/22.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/23.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/24.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/25.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/26.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/27.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/28.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/29.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/30.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/31.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/32.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/33.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/34.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/35.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/36.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/37.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/38.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/39.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/40.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/41.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/42.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/43.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/44.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/45.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/46.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/47.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/48.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/49.gif',
                'http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/50.gif'
            ]
        }
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $linkInput = $('<input type="text" class="block" placeholder=\'请输入腾讯视频地址\'/>');
        ...
        var $widthInput = $('<input type="text" value="100" style="width:50px;text-align:center;display:none;"/>');
        var $heightInput = $('<input type="text" value="250" style="width:50px;text-align:center;display:none;"/>');
        var $iframes=$('<iframe src=""></iframe>')
        ...
        //var $howToCopy = $('<a href="http://www.kancloud.cn/wangfupeng/wangeditor2/134973" target="_blank" style="display:inline-block;margin-top:10px;margin-left:10px;color:#999;">如何复制视频链接？</a>'); .append($howToCopy)
        var $btnSubmit = $('<button class="right">' + lang.submit + '</button>');
        var $btnCancel = $('<button class="right gray">' + lang.cancel + '</button>');
        ...
        $btnSubmit.click(function (e) {
			...
			var dd1 = '<object data="';
			var dd2 ='"><param name="movie" value="';
			var dd3 = '"><param name="windowlessVideo" value="1"><param name="fullScreen" value="0"><param name="windowlessVideo" value="0"></object>';
			
            //var $srcp=" <embed type='application/x-shockwave-flash'  src='";
            //var $srcb="' />";
			
			var o_url = $linkInput.val();
			
			
			var start_vid = o_url.indexOf("vid=");
			var vid2 = o_url.substr(start_vid+4,11);
			
			if(start_vid==-1){
				var page = o_url.indexOf("page");
				var vid2 = o_url.substr(page+11,11);
				
				
				if(page==-1){
					var leng=o_url.split('/').length;
                       vid2=o_url.split('/')[leng-1].split('.html')[0];
				}
			}
			...
			var n_url = "http://v.qq.com/iframe/player.html?vid="+vid2+"&tiny=0&auto=0";
			//var n_url = "http://static.video.qq.com/TPout.swf?vid="+vid2+"&auto=0";
            ...
            //var link = $.trim($srcp+$linkInput.val()+$srcb);
			//var link = $srcp+$linkInput.val()+$srcb;
			//var link = $ddd;
			//alert(link);
			var link = $.trim(dd1+$linkInput.val()+dd2+$linkInput.val()+dd3);
            ...
            var $div = $('<div>');
            var html = '<p class="pi" style="text-align:center; height:auto;">{content}</p>';
    ...
    //        	if(!$('embed').length<0){
	   //        	//给其追加一个父级
				...
				//	$('embed').prop("allowfullscreen",false);
				//}else{
				//	$('embed').prop("allowfullscreen",false);
				//	$('embed').prop("allowfullscreen","false");
				//}
   //        	if(!! $('#pi').length){
	  //         	//给其追加一个父级
			//	$(".pi").wrap(document.createElement("div"));
			//	$(".pi").parent().attr("class","videoW");
			//}else{
			//	$("iframe").parent().attr("class","pi");
			//	$(".pi").wrap(document.createElement("div"));
			//	$(".pi").parent().attr("class","videoW");
			//}
...
//给表情加一个类
$(".sub").click(function(){
				$(".wangEditor-txt").find("img").each(function(index){
					var esrc="http://wx.papaquan.com/wx/Public/Admin/editor/static/emotions/default/"
					var imsrc=$(this).attr('src');
					var imsrcs=imsrc.substring(0,70);
					if(imsrcs==esrc){
